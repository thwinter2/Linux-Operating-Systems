...
struct	pentry	{
	...
	int	pwaitret;
	int pinh;	// current inherited priority of proc
	int locklist[50];	//list of all locks held by proc. Size of NLOCKS = 50
	int lockid;	//ID of lock descriptor in whose wait queue the proc is blocked
};
