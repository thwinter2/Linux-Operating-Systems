...
struct	pentry	{
	...
	int	pwaitret;
	int syscall_counts[27];	//count of each type of system call
	int syscall_times[27];	//total execution time for each type of system call
	/*
	syscall_names='freemem','chprio','getpid','getprio','gettime','kil',
	...
	^^^ order in names list in printsyscallsummary.c matches respective order in counts,times lists ^^^
